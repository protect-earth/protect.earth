              ...
              <div class="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                <div class="py-6 px-3 mt-32 sm:mt-0">
                  <button
                    ...
                    type="button" style="transition: all 0.15s ease 0s;">Connect
                  </button>
                </div>
              </div>
              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:w-9/12 px-4">
                  ...
                  <p class="mb-4 text-lg leading-relaxed text-gray-800">Together with contributions from 50+ people, we
                    gather resources to help everyone find their next
                    piece of climate action. The climate crisis might be overwhelming when you start to understand the
                    severity of it all, but if we can get people on board with simplifying their lives, reducing their
                    footprint, offsetting the remaining footprint for barely any money, and reducing the insane
                    amounts of waste we all cause, our kids might have a chance.</p>

                  <a href="#pablo" class="font-normal text-pink-500">Show more</a></div>
              </div>
            </div>
          </div>
        </div>
